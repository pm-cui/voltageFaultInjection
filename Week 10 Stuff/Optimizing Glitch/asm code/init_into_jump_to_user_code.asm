reset handler registers inits:
    ...
    mov     r5, 0x08000000
    add     r5, r5, #0x116
    mov     pc, r5                   ; Start of user code after the inits
...
; Register inits
    ...
    0x4FF00065
    0x05F58B75
    0xAF46          ; Checksum for this section: 0x4A052456     String: 4FF0006505F58B75AF46
;AFF5B81E, 4f

    Size: 146 bytes (0x91 for 145)
    checksum: 0x990C8753 > 0x41
    checksum to be sent: 0xD0
